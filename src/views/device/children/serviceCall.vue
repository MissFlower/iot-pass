...
<template>
  <div style="padding-top: 10px;">
    ...
    <!-- 列表 -->
    <ElTable :data="listData" border v-loading="loading">
      <ElTableColumn label="时间" prop="time"></ElTableColumn>
      <ElTableColumn label="标识符" prop="time"></ElTableColumn>
      <ElTableColumn label="服务名称" prop="time"></ElTableColumn>
      <ElTableColumn label="输入参数" prop="time"></ElTableColumn>
      <ElTableColumn label="输出参数" prop="time"></ElTableColumn>
    </ElTable>
    <!-- 分页 -->
