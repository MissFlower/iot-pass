...
<template>
  <div class="details">
      <div class="details-tit clearfix">
          ...
          <el-tag :type="details.deviceType" class="el_tag" v-if="details.detailList.fmStatus || details.detailList.fmStatus == 0">{{fmStatusObj[details.detailList.fmStatus].label}}</el-tag>
      </div>
          ...
          <el-tabs v-model="detailsTab" type="card" @tab-click="handleClick" v-loading="loading">
              <el-tab-pane label="批次管理" name="first">
                  ...
                  <el-table :data="batchManage.batchList" border stripe>
                      ...
                      >
                      <template slot-scope="scope">
                        <div :style="{'background-color': taskStatusObj[scope.row.taskStatus].color}" class="point"></div>
                        <span v-if="scope.row.taskStatus || scope.row.taskStatus == 0">{{taskStatusObj[scope.row.taskStatus].label}}</span>
                        </template>
                      </el-table-column>
                      <el-table-column
                          label="添加时间"
              ...
              <el-tab-pane label="设备列表" name="second">
                  ...
                  <el-table :data="devManage.devList" border stripe>
                      ...
                      >
                        <template slot-scope="scope">
                          <div :style="{'background-color': upgradeStatusObj[scope.row.status].color}" class="point"></div>
                  ...
                  <el-row>
                      ...
                      <el-col :span="8">
                          <div class="edit_info">
                              ...
                              <div class="edit_info-rf">
                                  <span v-if="fmInfo.fmInfoList.fmStatus || fmInfo.fmInfoList.fmStatus == 0">{{fmStatusObj[fmInfo.fmInfoList.fmStatus].label}}</span>
                              </div>
                          </div>
                      </el-col>
                      <!--<el-col :span="24">-->
