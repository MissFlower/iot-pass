<template>
  <div id="index">
    <div class="main">
      <div class="desc">
        <div class="desc_con">
          <div class="desc_con_info">
            <div class="desc_title">物联网平台</div>
            <div
              class="info"
            >IoT物联网平台提供了一站式的设备接入、设备管理、监控运维、数据流转、数据存储等服务，具备高可用性、高并发、高性价比的特性，是企业设备上云的首选。</div>
            <div class="btn_con">
              <span
                class="btn"
                v-for="(row, index) in btnArr"
                :key="index"
                :class="row.class"
          ...
          <div class="desc_con_img"></div>
        </div>
        <div class="desc_footer">
          <div class="desc_footer_con df ai_c f14">
            <div>了解更多</div>
            <div class="red">免费试用</div>
            <div class="red">帮助文档</div>
            <div class="red">设备开发指南</div>
          </div>
        </div>
      </div>
      <div class="product">
        <div class="product-con df ai_c jc_sb">
          <div
            class="product_item hand"
...
#index {
  ...
  .desc {
    width: 100%;
    height: 540px;
    background-image: linear-gradient(to right,#50e986, #2A9F52);
    position: relative;
    color: #fff;
    .desc_con {
      max-width: 1200px;
  ...
  .product {
    ...
    .product-con {
      ...
      .product_item + .product_item {
        border-left: 1px solid rgba(55, 61, 65, 0.3);
      }
    }
  }
}
