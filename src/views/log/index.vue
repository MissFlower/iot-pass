        ...
        <el-input v-model="formInline.productKey" class="searchInput" placeholder="产品key查询">
          <span slot="suffix">
            ...
            <i
              ...
              v-if="formInline.productKey != ''"
              @click="clearFun('productKey')"
            ></i>
          </span>
        </el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-input v-model="formInline.deviceName" class="searchInput" placeholder="设备名称">
          <span slot="suffix">
            ...
            <i
              class="el-icon-close hand"
              v-if="formInline.deviceName != ''"
              @click="clearFun('deviceName')"
            ></i>
          </span>
        </el-input>
      </el-form-item>
      <el-form-item>
        <el-input v-model="formInline.keyword" class="searchInput" placeholder="关键字">
          <span slot="suffix">
            ...
            <i
              class="el-icon-close hand"
              v-if="formInline.keyword != ''"
              @click="clearFun('keyword')"
            ></i>
          </span>
        </el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-input v-model="formInline.messageId" class="searchInput" placeholder="消息id">
          <span slot="suffix">
            ...
            <i
              class="el-icon-close hand"
              v-if="formInline.messageId != ''"
              @click="clearFun('messageId')"
            ></i>
          </span>
        </el-input>
      </el-form-item>
