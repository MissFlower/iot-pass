...
<template>
  <div id="passwordFind" v-loading="loading">
    <div class="con" v-if="flag < 3">
      ...
      <el-form ref="form" :model="formData" :rules="rules" label-width="200px" class="mt30">
        ...
        <el-form-item label="新密码" v-if="flag" prop="password">
          <el-input v-model="formData.password" placeholder="请输入新密码" class="w200" show-password></el-input>
        </el-form-item>
        <el-form-item label="确认新密码" v-if="flag" prop="newpassword">
          <el-input v-model="password" placeholder="再次输入新密码" class="w200" show-password></el-input>
        </el-form-item>
        <el-form-item>
          <el-button
            class="mt20"
    ...
    <div else class="con df" v-if="flag == 3">
      ...
      <div class="ml20">
        ...
        <router-link to="/login" class="red f12">重新登录</router-link>
      </div>
    </div>
  </div>
</template>
