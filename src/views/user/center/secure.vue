    ...
    <div class="con">
      ...
      <div class="set-con">
        <div class="set-con-item df ai_c">
          ...
          <div class="flex1">安全性高的密码可以使帐号更安全。建议您定期更换密码，设置一个包含字母，符号或数字中至少两项且长度超过6位的密码。</div>
          <div class="op">
            <svg-icon icon-class="success"></svg-icon>
            <span class="success ml5 mr20">已设置</span>
            <span class="blue">修改</span>
          </div>
        </div>
        <div class="set-con-item df ai_c">
          <div class="name b">手机绑定</div>
          <div class="flex1">您已绑定了手机176****5702 [您的手机为安全手机，可以找回密码，但不能用于登录]</div>
          <div class="op">
            <svg-icon icon-class="success"></svg-icon>
            <span class="success ml5 mr20">已设置</span>
            <span class="blue">修改</span>
        ...
        <div class="set-con-item df ai_c">
          ...
          <div class="flex1">您已绑定了邮箱mawj****@163.com [阿里云发送的各类系统、营销、服务通知将发送到您的备用邮箱。]</div>
          <div class="op">
            <svg-icon icon-class="success"></svg-icon>
            <span class="success ml5 mr20">已设置</span>
            <span class="blue">修改</span>
